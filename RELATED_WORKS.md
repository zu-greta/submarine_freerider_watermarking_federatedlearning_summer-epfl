...
- diction section 2.2
- fedIPR algo 3
- Riga: Covert and robust white-box watermarking of deep neural networks (embedding the wm in the entire model with regularizer) + Embedding watermarks into deep neural networks (post processing wm): other types of watermarking we dont care about
- WAFFLE has pre-train phase and just special aggregation to keep the wm embedded but it is in federated context 
- blackmarks - embedding wm not in FL and during fine-tuning [paper](https://arxiv.org/abs/1904.00344)
- [EGG](https://ieeexplore.ieee.org/abstract/document/11495080) - box-free but not what i am looking for???
...
- 21 - first intro of FR concept and then 10 for more complex FR
